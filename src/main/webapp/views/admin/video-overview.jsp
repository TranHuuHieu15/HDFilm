	                  ...
	                  <tbody>
							<c:forEach var="video" items="${videos }">
								<tr>
									...
									<td>
										<img src="${video.poster }" alt="" width="250px" height="150px"/>
									</td>
									<td>
										<a href="<c:url value='/admin/video?action=edit&href=${video.href }'/>" type="button" class="btn btn-block btn-warning btn-sm">Edit</a>
										<button type="button" onclick="deleteVideo('${video.href}')" class="btn btn-block btn-danger btn-sm">Delete</button>
									</td>
								</tr>
							</c:forEach>
	                  </tbody>
