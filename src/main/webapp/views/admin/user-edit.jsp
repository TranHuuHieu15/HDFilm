        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<c:url value='/admin/user?action=add'/>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>New or Edit</p>
                </a>
              </li>
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input type="text" id="username" name="username" value="${user != null ?user.username:'' }" class="form-control">
                <input type="hidden" id="isEdit" value="${isEdit}" class="form-control">
              </div>
              <div class="form-group">
                <label for="href">Email</label>
                <input type="email" id="email" name="email" value="${user != null ?user.email:'' }" class="form-control">
              </div>
              <div class="form-group">
...
<script type="text/javascript">
	var usernameOrigin, emailOrigin, passwordOrigin;
	...
	$('#submitBtn').click(function() {
		...
		if (isEdit == 'true') {
			URL = '/asmJava4/admin/user?action=edit&username='+ usernameOrigin;
			titleAlert = 'Update user successfully';
		} else {
			URL = '/asmJava4/admin/user?action=add';
			titleAlert = 'Create user successfully';
		}
		var formData = {
			'usernameOrigin': $('#username').val(),
